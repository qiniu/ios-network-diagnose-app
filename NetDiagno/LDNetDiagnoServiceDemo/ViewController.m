...
- (void)startNetDiagnosis
{
    ...
    _netDiagnoService.dormain = [self cutDomrmainString];
    if (!_isRunning) {
...
- (NSString *)cutDomrmainString
{
    NSString *domains = _txtfield_dormain.text;
    NSArray * array = [_txtfield_dormain.text componentsSeparatedByString:@"/"];
    NSRange httpRange = [_txtfield_dormain.text rangeOfString:@"http"];
